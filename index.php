...
<body>
     ...
     <div class="col-md-5 p-lg-5 mx-auto my-5">
       ...
       <h1 class="display-4 fw-normal text-success">اربح مع عالية </h1>
     ...
     <div class="container">
     <ul class="list-group">
        <li class="list-group-item list-group-item-info" aria-current="true">كسب الربح من الإنترنت</li>
        <li class="list-group-item">طريقة ثانية للربح عبر الإنترنت</li>
        <li class="list-group-item">الربح من الإنترنت بطريقة ثالثة</li>
        <li class="list-group-item">ربح الأموال من الإنترنت بأربعة أساليب</li>
        <li class="list-group-item">وطريقة خامسة لكسب الأموال عبر الإنترنت</li>
     </ul>
